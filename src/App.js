...
function App() {
  ...
  let total = basket.reduce((a, b) => {
    return a + parseFloat(b.quantity, 10) * parseFloat(b.price, 10);
  }, 0);
  total > 100 ? (total -= total * 0.1) : (total = total);
  ...
  return (
    <div className="App">
      ...
      <div className="line" style={{ width: content == 0 ? "60%" : "59.2%" }} />
